...
func OAuth2DeviceFactory(config *Config, storage interface{}, strategy interface{}) interface{} {
	return &oauth2.DeviceHandler{
		...
		DeviceAuthTokenPollingInterval: config.GetDeviceAuthTokenPollingInterval(),
		DeviceVerificationURL:          config.DeviceVerificationURL,
		RefreshTokenScopes:             config.GetRefreshTokenScopes(),
	}
}
